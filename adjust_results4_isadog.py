...
def adjust_results4_isadog(results_dic, dogsfile):
    ...
    with open(dogsfile,'r') as infile:
        ...
        # Process each line infile until EOF
         while line != '':
                ...
                # Reads in next line infile to be processed with while loop 
                 line = infile.readline()
        ...
        # results_dic if labels are found in dog names_dic then label 'is a dog'
